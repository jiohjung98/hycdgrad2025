      ...
      <div className="container-responsive bg-white/60 backdrop-blur-sm py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-cyan-900 mb-8 text-center">
            HYCD Graduate Design 2025
          </h2>
          <div className="prose prose-lg text-cyan-900">
            <p className="text-lg leading-relaxed mb-6">
              Welcome to the HYCD Graduate Design 2025 showcase. This platform
              celebrates the innovative work and creative vision of our
              graduating design students.
            </p>
            <p className="text-lg leading-relaxed mb-6">
              Our students have explored various design disciplines including
              branding, UX/UI, editorial design, and packaging design, pushing
              the boundaries of creativity and innovation.
            </p>
            <p className="text-lg leading-relaxed">
              Explore their projects and discover the future of design through
              their unique perspectives and groundbreaking solutions.
            </p>
          </div>
        </div>
      </div>
